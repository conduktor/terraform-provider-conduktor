...
func TestTopicV2ModelMapping(t *testing.T) {
	...
	assert.Equal(t, map[string]interface{}{"name": "topic", "cluster": "cluster", "labels": map[string]interface{}{"kind": "topic"}, "catalogVisibility": "PRIVATE", "descriptionIsEditable": true, "description": "This is a topic", "sqlStorage": map[string]interface{}{"retentionTimeInSecond": float64(86400), "enabled": true}}, ctlResource.Metadata)
