...
func TFToInternalModel(ctx context.Context, r *groups.ConsoleGroupV2Model) (model.GroupConsoleResource, error) {
	// ExternalGroups
...
func InternalModelToTerraform(ctx context.Context, r *model.GroupConsoleResource) (groups.ConsoleGroupV2Model, error) {
