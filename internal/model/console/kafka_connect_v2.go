...
const (
	CONNECT_BASIC_AUTH   KafkaConnectSecurityType = "BasicAuth"
	CONNECT_BEARER_TOKEN KafkaConnectSecurityType = "BearerToken"
	CONNECT_SSL_AUTH     KafkaConnectSecurityType = "SSLAuth"
)
