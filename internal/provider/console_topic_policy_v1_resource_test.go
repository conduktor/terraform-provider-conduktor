		...
		Steps: []resource.TestStep{
			...
			// Create and Read from complex example
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("conduktor_console_topic_policy_v1.complex", "spec.policies.spec.configs.retention.ms.range.max", "3600000"),
					resource.TestCheckResourceAttr("conduktor_console_topic_policy_v1.complex", "spec.policies.spec.configs.retention.ms.range.min", "60000"),
					...
					resource.TestCheckResourceAttr("conduktor_console_topic_policy_v1.complex", "spec.policies.spec.replicationFactor.none_of.values.#", "1"),
					resource.TestCheckResourceAttr("conduktor_console_topic_policy_v1.complex", "spec.policies.spec.replicationFactor.none_of.values.0", "3"),
					...
					resource.TestCheckResourceAttr("conduktor_console_topic_policy_v1.complex", "spec.policies.metadata.name.match.pattern", "^click.(?<event>[a-z0-9-]+).(avro|json)$"),
