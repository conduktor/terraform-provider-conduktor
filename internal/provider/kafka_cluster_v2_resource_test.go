...
func TestAccKafkaClusterV2Minimal(t *testing.T) {
	...
	resourceRef := "conduktor_kafka_cluster_v2.minimal"
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { test.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: testAccProtoV6ProviderFactories,
		Steps: []resource.TestStep{
...
func TestAccKafkaClusterV2ExampleResource(t *testing.T) {
	...
	var simpleResourceRef = "conduktor_kafka_cluster_v2.simple"
	var gatewayResourceRef = "conduktor_kafka_cluster_v2.gateway"
	var aivenResourceRef = "conduktor_kafka_cluster_v2.aiven"
	var awsResourceRef = "conduktor_kafka_cluster_v2.aws_msk"
	var confluentResourceRef = "conduktor_kafka_cluster_v2.confluent"
