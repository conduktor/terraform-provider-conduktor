		...
		Steps: []resource.TestStep{
			...
			// Create and Read from complex example
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("conduktor_console_application_instance_v1.complex", "spec.resources.4.type", "TRANSACTIONAL_ID"),
					resource.TestCheckResourceAttr("conduktor_console_application_instance_v1.complex", "spec.resources.4.name", "click."),
					resource.TestCheckResourceAttr("conduktor_console_application_instance_v1.complex", "spec.resources.4.pattern_type", "PREFIXED"),
					resource.TestCheckResourceAttr("conduktor_console_application_instance_v1.complex", "spec.resources.5.type", "TOPIC"),
					resource.TestCheckResourceAttr("conduktor_console_application_instance_v1.complex", "spec.resources.5.name", "legacy-click."),
					resource.TestCheckResourceAttr("conduktor_console_application_instance_v1.complex", "spec.resources.5.pattern_type", "PREFIXED"),
