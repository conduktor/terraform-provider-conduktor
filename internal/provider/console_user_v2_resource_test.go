		...
		Steps: []resource.TestStep{
			...
			// Create and Read from example
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.firstname", "Bob"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.lastname", "Smith"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.#", "2"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.0.resource_type", "TOPIC"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.0.name", "test-topic"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.0.pattern_type", "LITERAL"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.0.cluster", "*"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.0.permissions.#", "3"),
					resource.TestCheckResourceAttr("conduktor_console_user_v2.example", "spec.permissions.1.resource_type", "PLATFORM"),
