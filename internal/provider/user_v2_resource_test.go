		...
		Steps: []resource.TestStep{
			...
			// Create and Read from example
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("conduktor_user_v2.example", "spec.permissions.0.resource_type", "PLATFORM"),
					resource.TestCheckResourceAttr("conduktor_user_v2.example", "spec.permissions.0.permissions.#", "3"),
					resource.TestCheckResourceAttr("conduktor_user_v2.example", "spec.permissions.1.resource_type", "TOPIC"),
					resource.TestCheckResourceAttr("conduktor_user_v2.example", "spec.permissions.1.name", "test-topic"),
					resource.TestCheckResourceAttr("conduktor_user_v2.example", "spec.permissions.1.pattern_type", "LITERAL"),
					resource.TestCheckResourceAttr("conduktor_user_v2.example", "spec.permissions.1.cluster", "*"),
