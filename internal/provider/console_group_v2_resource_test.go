...
func TestAccGroupV2Resource(t *testing.T) {
	...
	resourceRef := "conduktor_console_group_v2.test"
		...
		Steps: []resource.TestStep{
			// Create and Read from minimal example
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("conduktor_console_group_v2.minimal", "spec.external_groups.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.minimal", "spec.members.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.minimal", "spec.members_from_external_groups.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.minimal", "spec.permissions.#", "0"),
				),
			},
			// Delete testing automatically occurs in TestCase
		},
...
func TestAccGroupV2ExampleResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: providerConfigConsole + test.TestAccExample(t, "resources", "conduktor_console_group_v2", "simple.tf"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "name", "simple-group"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.display_name", "Simple Group"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.description", "Simple group description"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.external_groups.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.members.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.members_from_external_groups.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.permissions.#", "0"),
				),
			},
			// Create and Read from complex example
			{
				Config: providerConfigConsole + test.TestAccExample(t, "resources", "conduktor_console_group_v2", "complex.tf"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "name", "complex-group"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.display_name", "Complex group"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.description", "Complex group description"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.external_groups.#", "1"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.external_groups.0", "sso-group1"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.members.#", "1"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.members.0", "user1@company.com"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.members_from_external_groups.#", "0"),
					resource.TestCheckResourceAttr("conduktor_console_group_v2.example", "spec.permissions.#", "2"),
				),
			},
		},
	})
