...
func TestAccKafkaConnectV2ExampleResource(t *testing.T) {
	...
	var mtlsResourceRef = "conduktor_kafka_connect_v2.mtls"
	var basicResourceRef = "conduktor_kafka_connect_v2.basic"
	var bearerResourceRef = "conduktor_kafka_connect_v2.bearer"
