...
func (r *UserV2Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data schema.ConsoleUserV2Model
	...
	var consoleRes console.UserConsoleResource
